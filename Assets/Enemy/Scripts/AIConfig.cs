...
public class AIConfig : ScriptableObject {
    ...
    [Tooltip("Minimum distance required to attack player")] [SerializeField] private float _attackRadius = 2.0f;
    [Tooltip("Health the enemy starts with")] [SerializeField] private float _health = 100.0f;
    [Tooltip("Probability that enemy will transition to attack and not taunt")] [SerializeField] [Range(0.0f, 1.0f)] private float _attackChance = 0.5f;
    [Tooltip("Minimum amount of time to wait before initiating next attack")] [SerializeField] private float _attackCoolDown = 5.0f;
    [Tooltip("Minimum amount of time to wait before initiating next taunt")] [SerializeField] private float _tauntCoolDown = 3.0f;
    ...
    public int DeactivateDelay { get => _deactivateDelay; }
